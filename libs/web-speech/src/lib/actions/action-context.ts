...
export class ActionContext {
  ...
  changeThemeStrategy = inject(ChangeThemeStrategy);
  titleService =  inject(Title);
  speechSynthesizer = inject(SpeechSynthesizerService);
  changeTitleStrategy = inject(ChangeTitleStrategy);
  constructor() {
    this.changeTitleStrategy.titleService = this.titleService;
  }
